...
class R5KonfirmasiDibatalkanTest extends DuskTestCase
{
    /**
     * Test Rule 5: Konfirmasi penerimaan pelamar dibatalkan (Klik Batal).
     */
    public function test_konfirmasi_diterima_dibatalkan(): void
    {
        ...
        // Verifikasi database: pastikan status tidak berubah
        $wawancara->refresh();
        $this->assertEquals('proses', $wawancara->status);
