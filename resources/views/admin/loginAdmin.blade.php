...
<head>
    ...
    <title>Masuk Admin | KerjaKuy</title>
            ...
            <div class="hero-gradient p-xl flex flex-col justify-between relative overflow-hidden hidden lg:flex">
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-xs mb-lg">
                        ...
                        <span class="text-white font-headline-md text-headline-md font-bold">KerjaKuy <span class="text-secondary-fixed">Admin</span></span>
                    </div>
                    <h1 class="font-headline-xl text-headline-xl text-white mb-sm">Panel Administrasi KerjaKuy</h1>
                    ...
                    <form class="space-y-md" method="POST" action="{{ route('admin.login.post') }}">
                        ...
                        <div class="space-y-xs">
                            ...
                            <div class="relative">
                                ...
                                <input class="w-full pl-12 pr-md py-3 bg-surface border border-outline-variant rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:border-transparent transition-all font-body-md text-body-md" id="email" name="email" value="{{ old('email') }}" placeholder="admin@kerjakuy.com" type="email" required>
                            </div>
                        </div>
                        <!-- Password Field -->
                        <div class="space-y-xs">
    ...
    <footer class="bg-primary py-xl border-t border-outline-variant">
        <div class="max-w-7xl mx-auto px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-gutter">
            <div class="flex flex-col items-center md:items-start gap-xs">
                <span class="font-headline-md text-headline-md font-bold text-on-primary">KerjaKuy</span>
                <p class="font-label-sm text-label-sm text-on-primary-container/80">© 2024 KerjaKuy. All rights reserved.</p>
            </div>
